      ...
      <div class="flex gap-4 mb-8 overflow-x-auto pb-2 whitespace-nowrap categories-container">
        <button 
          ...
          :class="[
            ...
            !selectedCategory ? 'bg-teal-600 text-white h-10 flex items-center justify-center text-center leading-none' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 h-10 flex items-center justify-center text-center leading-none'
          ]"
        >
          ALL
        </button>
        <button 
          ...
          :class="[
            'inline-block w-24 py-2 rounded-full transition-all duration-300 transform hover:scale-105 flex items-center justify-center text-center leading-none',
            selectedCategory === category.id ? 'bg-teal-600 text-white h-10 flex items-center justify-center text-center leading-none' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 h-10 flex items-center justify-center text-center leading-none'
          ]"
        >
          {{ category.name }}
        </button>
